...
|---|---|---|---|---|
| +100ms | Governance | Agent registered | `agt-demo-001` | type: model-promotion |
| +200ms | Governance | Passport issued | `agt-demo-001` | scope: model.promote:model/* |
...
| +1100ms | Governance | Scope evaluated | `agt-demo-001` | model.promote + model/champion-v3 -> ALLOW |
...
3. **Authorization gap**: OpenShell denied POST, but no governance scope evaluation exists for that action — the drift detector finds this.
