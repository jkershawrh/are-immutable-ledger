...
echo ""
echo -e "    ${BLUE}Governance${RESET}  — authority decisions (passport, scope, policy)"
...
echo -e "     ${BLUE}Governance${RESET} (authority) + ${GREEN}OpenShell${RESET} (isolation) + ${PURPLE}Kagenti${RESET} (orchestration)"
